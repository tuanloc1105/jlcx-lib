...
import vn.io.lcx.common.config.LogbackConfig;
import vn.io.lcx.common.constant.CommonConstant;
import vn.io.lcx.common.utils.CommonUtils;
import vn.io.lcx.common.utils.JVMSystemInfo;
import vn.io.lcx.common.utils.LogUtils;
import vn.io.lcx.vertx.base.annotation.app.ComponentScan;
    ...
    private void deployVerticle(final List<String> packagesToScan, Supplier<Void> preconfigure) {
        ...
        try {
            ...
            if (enableMetric) {
                ...
                if (vn.io.lcx.common.utils.MyStringUtils.isNotBlank(metricPortString) && vn.io.lcx.common.utils.MyStringUtils.isNumeric(metricPortString)) {
