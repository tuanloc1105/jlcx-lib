...
import static vn.io.lcx.common.database.utils.EntityUtils.getTableShortenedName;

public class PostgreSQLPageable implements Pageable {
    ...
    public PostgreSQLPageable() {
    }

    public PostgreSQLPageable(int pageNumber,
                              int pageSize,
    ...
    public static PostgreSQLPageable.PostgreSQLPageableBuilder builder() {
        return new PostgreSQLPageable.PostgreSQLPageableBuilder();
    }
    ...
    @Override
    public PostgreSQLPageable add(String fieldName, Direction direction) {
    ...
    public static class PostgreSQLPageableBuilder {
        private int pageNumber;
        private int pageSize;
        private Map<String, Direction> columnNameAndDirectionMap;
        private Map<String, Direction> fieldNameAndDirectionMap;
        ...
        public PostgreSQLPageableBuilder() {
        }

        public PostgreSQLPageable.PostgreSQLPageableBuilder pageNumber(int pageNumber) {
            this.pageNumber = pageNumber;
            return this;
        }

        public PostgreSQLPageable.PostgreSQLPageableBuilder pageSize(int pageSize) {
            this.pageSize = pageSize;
            return this;
        }

        public PostgreSQLPageable.PostgreSQLPageableBuilder columnNameAndDirectionMap(Map<String, Direction> columnNameAndDirectionMap) {
            this.columnNameAndDirectionMap = columnNameAndDirectionMap;
            return this;
        }

        public PostgreSQLPageable.PostgreSQLPageableBuilder fieldNameAndDirectionMap(Map<String, Direction> fieldNameAndDirectionMap) {
            this.fieldNameAndDirectionMap = fieldNameAndDirectionMap;
            return this;
        }

        public PostgreSQLPageable.PostgreSQLPageableBuilder entityClass(Class<?> entityClass) {
            this.entityClass = entityClass;
            return this;
        }

        public PostgreSQLPageable build() {
            return new PostgreSQLPageable(pageNumber, pageSize, columnNameAndDirectionMap, fieldNameAndDirectionMap, entityClass);
        }
    }
