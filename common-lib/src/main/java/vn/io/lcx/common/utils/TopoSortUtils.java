...
public final class TopoSortUtils {
    ...
    public static void printCircularDependencies(Map<String, List<String>> classDependencies) {
        List<String> circularPath = findCircularDependency(classDependencies);
        if (circularPath != null) {
            LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Circular dependency detected:");
            LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Path: " + String.join(" -> ", circularPath) + " -> " + circularPath.get(0));

            LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Detailed dependency information:");
            for (int i = 0; i < circularPath.size(); i++) {
                ...
                LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "  " + currentClass + " depends on: " + (dependencies != null ? dependencies.toString() : "[]"));
                LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "    -> Specifically depends on: " + nextClass);
            }
        } else {
            LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "No circular dependencies found.");
        }
    }
    ...
    public static List<String> topologicalSortWithDebug(Map<String, List<String>> classDependencies) {
        ...
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Input classes: " + classDependencies.keySet());
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Total input classes: " + classDependencies.size());

        List<String> result = topologicalSort(classDependencies);

        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Output classes: " + result);
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Total output classes: " + result.size());
        ...
        if (result.size() != classDependencies.size()) {
            ...
            LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Missing classes: " + missingClasses);
        }
    ...
    public static void analyzeDependencies(Map<String, List<String>> classDependencies) {
        ...
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Dependency Analysis:");
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Total unique dependencies: " + allDependencies.size());
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "Internal dependencies (in input map): " + internalDependencies);
        LogUtils.writeLog(vn.io.lcx.common.utils.TopoSortUtils.class, LogUtils.Level.DEBUG, "External dependencies (ignored): " + externalDependencies);
    }
}
